...
namespace Sakenny.Repository.Migrations
{
    ...
    [Migration("20250506162408_update favourite list")]
    partial class updatefavouritelist
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sakenny.Core.Models.PostFavouriteList", b =>
                {
                    ...
                    b.Property<int?>("FavouriteListId1")
                        .HasColumnType("int");

                    b.Property<int>("PostId1")
                        .HasColumnType("int");

                    b.HasKey("FavouriteListId", "PostId");

                    b.HasIndex("FavouriteListId1");
            ...
            modelBuilder.Entity("Sakenny.Core.Models.PostFavouriteList", b =>
                {
                    ...
                    b.HasOne("Sakenny.Core.Models.FavouriteList", null)
                        ...
                        .HasForeignKey("FavouriteListId1");
