...
{
    public class PostWithUnitAndUserWithFiltersNoPaginationSpec:BaseSpecification<Post>
    {
        public PostWithUnitAndUserWithFiltersNoPaginationSpec(FilterPostsSpec model) : base(p => !p.ISDeleted &&
